...
if [ "$1" = "train" ]; then
	...
	python3 run.py train --train-src=./ko_en_data/train.ko --train-tgt=./ko_en_data/train.en --dev-src=./ko_en_data/dev.chr --dev-tgt=./ko_en_data/dev.en --vocab=vocab.json --lr=5e-4
